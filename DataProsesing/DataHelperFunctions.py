...
def position_handler(position,modifier,value):
    ...
    if position == "start":  # prepend
        Debug.log(f"add modefier {modifier} to {value} before value","Info",group="LIB")
        Line = f"{modifier}{value}"
    elif position == "end":  # append
        Debug.log(f"add modefier {modifier} to {value} after value","Info",group="LIB")
        Line = f"{value}{modifier}"
    elif position == "both":  # append
        Debug.log(f"add modefier {modifier} to {value} before and after value","Info",group="LIB")
