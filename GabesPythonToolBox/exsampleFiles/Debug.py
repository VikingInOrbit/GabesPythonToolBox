...
Debug.log(
    "------------------------------------------", message_type="Info", group="Showcase"
)
...
Debug.log("This is a New style message", message_type=LogType.Success)
Debug.log("This is a Old style message", message_type="Success")
Debug.log("\n\n\n", message_type="None", group="Showcase")

# Using a group filter
Debug.log(
    "This should be shown since 'LIB' is enabled", message_type="Info", group="LIB"
)
Debug.log(
    "This should NOT be shown since 'Database' is disabled",
    message_type="Info",
    group="Database",
)
...
Debug.log(
    "This should now be shown since 'Database' is enabled",
    message_type="Info",
    group="Database",
)
...
Debug.log(
    "This should NOT be shown since 'LIB' is now disabled",
    message_type="Info",
    group="LIB",
)
...
Debug.log(
    "This should be shown since 'LIB' is now enabled", message_type="Info", group="LIB"
)
