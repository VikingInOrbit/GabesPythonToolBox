...
def test():
    ...
    Debug.log(
        f"Map; minInput: {inputMin}, MaxInput: {inputMax}, minOutput: {OutputMin}, maxOutput: {OutputMax}",
        "Info",
        group="Showcase",
    )
    ...
    Debug.log(
        f"ClampMap; minInput: {inputMin}, MaxInput: {inputMax}, minOutput: {OutputMin}, maxOutput: {OutputMax}",
        "Info",
        group="Showcase",
    )
    for x in range(inputMin - diff, inputMax + 1 + diff):
