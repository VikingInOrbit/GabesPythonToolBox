...
Debug.log(
    f"Updated Player Name: {config_manager()['player']['name']}",
    message_type="Info",
    group="Showcase",
)
...
Debug.log(
    f"Updated Game Difficulty: {config_manager()['game_settings']['difficulty']}",
    message_type="Info",
    group="Showcase",
)
Debug.log("", message_type="None", group="Showcase")
...
Debug.log(
    f"Current Inventory: {config_manager()['player']['inventory']}",
    message_type="Info",
    group="Showcase",
)
...
Debug.log(
    f"Updated Inventory: {config_manager()['player']['inventory']}",
    message_type="Info",
    group="Showcase",
)
Debug.log("", message_type="None", group="Showcase")
...
Debug.log(
    f"Quest Progress (Defeat the Dragon): {config_manager()['quests']['active'][0]['progress']}",
    message_type="Info",
    group="Showcase",
)
config_manager.update("quests.active[0].progress", 80)
Debug.log(
    f"Updated Quest Progress (Defeat the Dragon): {config_manager()['quests']['active'][0]['progress']}",
    message_type="Info",
    group="Showcase",
)
Debug.log("", message_type="None", group="Showcase")
...
Debug.log(
    f"Configuration has been saved back to '{output_dir}'",
    message_type="Info",
    group="Showcase",
)
...
Debug.log(
    "Replacing Stewart Platform with Omni Wheel Base",
    message_type="Info",
    group="Showcase",
)
config_manager.update(
    "robotics_system.stewart_platform",
    {
        "omni_wheel_base": {
            "wheels": [
...
Debug.log(
    config_manager()["robotics_system"]["robotic_arm"]["joints"][2],
    message_type="Info",
    group="Showcase",
)
...
Debug.log(
    config_manager()["robotics_system"]["sensors"]["imu"],
    message_type="Info",
    group="Showcase",
)
...
Debug.log(
    f"Updated config also saved as JSON to {json_out}",
    message_type="Info",
    group="Showcase",
)
