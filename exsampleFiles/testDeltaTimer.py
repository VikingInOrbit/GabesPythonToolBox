...
def test_timer_functionality(
    timer: DT.DeltaTimer, duration: float, label: str = ""
) -> None:
    """
    ...
    Debug.log(
        f"Current states: Started={timer.Started}, Finished={timer.Finished}, Stopped={timer.Stoped}",
        "Info",
        group="Showcase",
    )
    ...
    while not timer():
        Debug.log(
            f"Time left: {timer.getTimeLeft():.2f} seconds", "Info", group="Showcase"
        )
        time.sleep(0.5)

    Debug.log("Timer finished", "Info", group="Showcase")
    Debug.log(
        f"Final states: Started={timer.Started}, Finished={timer.Finished}, Stopped={timer.Stoped}",
        "Info",
        group="Showcase",
    )
...
def test_stop_timer(timer: DT.DeltaTimer) -> None:
    ...
    timer.startTimer()
    Debug.log(
        f"Timer started. States: Started={timer.Started}, Finished={timer.Finished}, Stopped={timer.Stoped}",
        "Info",
        group="Showcase",
    )
    ...
    time.sleep(2)
    Debug.log(
        f"Time left after 2 seconds: {timer.getTimeLeft():.2f} seconds",
        "Info",
        group="Showcase",
    )
    ...
    timer.stopTimer()
    Debug.log(
        f"Timer stopped. Time left: {timer.getTimeLeft():.2f} seconds",
        "Info",
        group="Showcase",
    )
    Debug.log(
        f"States after stop: Started={timer.Started}, Finished={timer.Finished}, Stopped={timer.Stoped}",
        "Info",
        group="Showcase",
    )
    ...
    time.sleep(2)
    Debug.log(
        f"Time left after 2 seconds post-stop: {timer.getTimeLeft():.2f} seconds",
        "Info",
        group="Showcase",
    )
...
def test_pause_resume_timer(timer: DT.DeltaTimer) -> None:
    ...
    time.sleep(1)
    Debug.log(
        f"Time left after 1 second: {timer.getTimeLeft():.2f} seconds",
        "Info",
        group="Showcase",
    )
    ...
    time.sleep(1)
    Debug.log(
        f"Time left after pause: {timer.getTimeLeft():.2f} seconds",
        "Info",
        group="Showcase",
    )
    ...
    Debug.log(
        f"Timer finished. States: Started={timer.Started}, Finished={timer.Finished}, Stopped={timer.Stoped}",
        "Info",
        group="Showcase",
    )
